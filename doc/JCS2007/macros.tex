...
\newcommand{\checkmem}{\ttt{checkmem}}
\newcommand{\riskplus}{\oplus}
\newcommand{\linkplus}{\oplus}
\newcommand{\isectplus}{\otimes}
\newcommand{\thresh}{\Theta}
\newcommand{\subjects}{\mathit{subjects}}
\newcommand{\shadowmap}[3]{#1[#2 : #3]}
\newcommand{\ponat}{\mathcal{N}}
\newcommand{\rmpaths}{\mathit{rmpaths}}
\newcommand{\tail}{\mathit{tail}}
\newcommand{\support}{\mathit{support}}
\newcommand{\rmempo}{\unlhd}
