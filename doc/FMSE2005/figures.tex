...
\begin{eqnarray*}
\bounds[\rmem](A.r) &=& \bigcup\limits_{\cred{A.r}{e}{\risk} \in \creds} 
\expr[\rmem](e) \oplus \risk \\[4mm]
\expr[\rmem](B) &=& \setdefn{(B,\bot)}\\
\expr[\rmem](A.r)&=& \rmem(A.r)\\
\expr[\rmem](A.r_1.r_2) &=& \bigcup\limits_{(B,\risk)\in \rmem(A.r_1)}
  \rmem(B.r_2) \oplus \risk \\
\expr[\rmem](f_1 \cap \cdots \cap f_n) &=&
   \bigoplus\limits_{1\le i \le n} \expr[\rmem](f_i)
\end{eqnarray*}
\end{fpfig*}
}